...
class OssUtils
{
    ...
    private function __construct()
    {
        ...
        // 初始化
        self::$app_key = Config::get('upload.oss.access_key_id');
        self::$app_secret = Config::get('upload.oss.access_key_secret');
        self::$pub_bucket_name = Config::get('upload.oss.pub_bucket_name');
        self::$pri_bucket_name = Config::get('upload.oss.pri_bucket_name');
        self::$expire = Config::get('upload.oss.expire');
        self::$endpoint = Config::get('upload.oss.endpoint_net');
